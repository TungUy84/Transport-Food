...
$sql = "UPDATE qlthucpham SET tensanpham='$tensanpham', size='$size', khoiluong='$khoiluong', datesx='$datesx', thanhtien='$thanhtien', img_tb='$tenhinh' WHERE id='$id'";
...
<body>
    <div class="desktop-2">
        ...
        <a href="../php/trangchu.php" class="qun-l-thc-phm-parent">
              <div class="qun-l-thc">Quản Lý Thực Phẩm</div>
              <img class="group-child" alt="" src="../banner/incon_supler.jpg">     
        </a>
    ...
    <div class="container">
        <h3 class="title">Chỉnh sửa thực phẩm:</h3>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="khoiluong" value="<?php echo $khoiluong; ?>">
            </div>
            <div>
                <label for="datesx">Ngày sản xuất</label>
                <input type="date" name="datesx" value="<?php echo $datesx; ?>">
            </div>
            <div>
